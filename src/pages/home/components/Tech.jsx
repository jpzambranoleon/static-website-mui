  ...
  return (
    <Container>
      ...
      <Typography variant="h6" align="center" color="text.secondary" paragraph>
        Our web apps are designed to match the quality of modern apps and being
        simple to use.
      </Typography>
      <Grid container spacing={3} align="center">
        <Grid item xs={12} sm={4}>
          ...
          <Typography variant="body1" color="text.secondary">
            Our applications are built to make your life easier. We design our
            apps with simple and enjoyable UI/UX components.
          </Typography>
        </Grid>
        <Grid item xs={12} sm={4}>
          <Avatar sx={{ width: 60, height: 60, mb: 2, bgcolor: blue[50] }}>
          ...
          <Typography variant="body1" color="text.secondary">
            Our development team uses modern frameworks such as React and MUI to
